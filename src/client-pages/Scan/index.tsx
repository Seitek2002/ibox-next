          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <h1 className='text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 sm:mb-8 leading-tight'>
              ...
              <span
                ...
                style={{
                  backgroundImage:
                    'linear-gradient(to right, #FDE68A, #F9A8D4)',
                }}
              >
                с ibox.kg
              </span>
          ...
          <div className='space-y-24 sm:space-y-32'>
            ...
            <div className='grid lg:grid-cols-2 gap-8 sm:gap-12 items-center'>
              <div className='order-2 lg:order-1'>
                ...
                <p className='text-lg text-gray-600 mb-6 sm:mb-8 leading-relaxed'>
                  Используйте мощь искусственного интеллекта для улучшения
                  визуального контента, работы с документами и общения с
                  клиентами. ИИ помогает автоматически обрабатывать фото
                  товаров, распознавать накладные и ускорять ответы на запросы
                  покупателей
                </p>
            ...
            <div className='grid lg:grid-cols-2 gap-8 sm:gap-12 items-center'>
              ...
              <div>
                ...
                <p className='text-lg text-gray-600 mb-6 sm:mb-8 leading-relaxed'>
                  Получайте полное представление о вашем бизнесе. Отслеживайте
                  ключевые метрики в реальном времени, анализируйте поведение
                  клиентов и принимайте решения на основе данных.
                </p>
                <ul className='space-y-4'>
                  {[
            ...
            <div className='grid lg:grid-cols-2 gap-8 sm:gap-12 items-center'>
              <div className='order-2 lg:order-1'>
                ...
                <p className='text-lg text-gray-600 mb-6 sm:mb-8 leading-relaxed'>
                  ...
                  складской учет, логистические партнеры, платежные системы,
                  мессенджеры и маркетинговые сервисы работают вместе в единой
                  экосистеме.
                </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
          ...
          <div className='border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center'>
            <div className='text-gray-400 text-sm mb-4 md:mb-0'>
              © {new Date().getFullYear()} ibox.kg. Все права защищены.
            </div>
